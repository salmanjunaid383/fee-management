...
const Listofunpaidfeevoucher = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://fee-management-api.nastechltd.co/api/unpaid_fee_voucher/${localStorage.getItem("school_id")}`)
      .then((response) => {
...
"></i>
        ...
        <div class="right-side">
          <div class="right-header">
            <div class="top-bar">
              <div class="top-bar-justify">
                <div class="big-inbox">Unpaid Voucher List</div>
          ...
          <div className="col-xl-12" style={{display:"flex" , justifyContent:"flex-end"}}>
                <Link to={`/Voucher-List`}>  <button className="btn btn-primary">View Paid Vouchers</button></Link>
              </div>
              </div>
...
export default Listofunpaidfeevoucher;
