...
const FeeVoucherCustom = ({ teamId, orientation = 'landscape' }) => {
    ...
    return (
        <>
            <div class="fee-voucher-main" style={{display:"flex", justifyContent:"center", width:"1530px"}}>
...
export default FeeVoucherCustom;
